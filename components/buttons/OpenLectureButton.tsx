...
export default function OpenLectureButton({
  ...
  return (
    <button
      type="button"
      onClick={handleOpen}
      className={`w-full bg-white hover:bg-blue-50 border dark:bg-slate-800 dark:hover:bg-slate-700 border-gray-200 dark:border-gray-700 rounded-xl p-6 transition-all group text-left shadow-sm ${className}`}
    >
