  ...
  return (
    <div className="flex flex-col space-y-2">
      <button
        ...
        disabled={loading}
        className={`relative w-full bg-white hover:bg-red-50 border border-gray-200 rounded-xl p-6 transition-all group text-left shadow-sm disabled:opacity-50 disabled:cursor-not-allowed overflow-hidden ${className}`}
      >
        {loading && (
        ...
        <p className="text-sm text-gray-600">
          Permanently remove this {itemType === "lecture" ? "recording" : "document"} from your library
        </p>
      </button>
