          ...
          <div className="hidden md:flex items-center space-x-3">
            ...
            {user ? (
              <>
                <Link
                  href="/profile"
                  className="flex items-center space-x-2 text-gray-700 dark:text-gray-200 hover:text-blue-600 dark:hover:text-blue-400 transition-all duration-200 font-medium px-5 py-2 rounded-lg hover:bg-blue-50 dark:hover:bg-slate-800"
                >
                ...
                <button
                  ...
                  className="flex items-center space-x-2 text-gray-700 dark:text-gray-200 hover:text-red-600 dark:hover:text-red-400 transition-all duration-200 font-medium px-5 py-2 rounded-lg hover:bg-red-50 dark:hover:bg-red-900/20"
                >
